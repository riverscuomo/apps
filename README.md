...
In the apps directory, run `py maintenance.py -m new_albums`. This should run the script that imports and runs the `new_albums` package. You should see some variation of this error:
